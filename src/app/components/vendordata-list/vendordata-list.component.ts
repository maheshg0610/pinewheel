...
@Component({
  selector: 'app-vendordata-list',
  templateUrl: './vendordata-list.component.html',
  styleUrls: ['./vendordata-list.component.scss']
})
export class VendorDataListComponent implements OnInit {
  public order = [];
  public temp = [];
